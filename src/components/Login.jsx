            ...
            <div className='Main__content'>
                ...
                <div className="Main__page">
                    ...
                    <div className="Main__page-message">
                        Новый пользователь? <a href="/" onClick={this.signup}>Зарегистрируйтесь</a>
                    </div>
                    <form className="Main__form">
                        <input className="Main__form-input" type="text" placeholder="Имя пользователя *"/>
                        <input className="Main__form-input" type="text" placeholder="Пароль *"/>
                        <button className="Main__form-submit"  onClick={this.submit}>Войти</button>
                    </form>
                </div>
            </div>
        )
